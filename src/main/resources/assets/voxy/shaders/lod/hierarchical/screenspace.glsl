...
void setupScreenspace(in UnpackedNode node) {
    ...
    _insideFrustum = !outsideFrustum(frustum, basePos, float(32<<node.lodLevel));
...
bool outsideFrustum() {
    return !_insideFrustum;// maxW < 16 is a trick where 16 is the near plane
